...
{
	/**
	 * Get cache directory for this setup.
	 *
	 * This file is in /source/StoryBB, we need to go up to /internal
	 *
	 * @return string Path to the internal folder.
	 */
	public static function get_cache_path(): string
	{
		return realpath(__DIR__ . '/../../internal');
	}
	...
	public static function rebuild_cache(): array
	{
		...
		$cachefile = '<?php $class_cache = ' . var_export($class_cache, true) . ';';
